  ...
  repQuests: [
    ...
    [
      ...
      generateDescription(
        ...
        'https://forded.github.io/ageofwater-map.github.io/icons/rep_quests.png',
        'Сильный одиночный большой который появляется в любом месте скопления игроков за картой в пределах 2000 единиц дистанции от игроков, корабль который убивается путем пробивания 4-х щитов по бортам и поломки двигателей за ними. Вооружен пулеметами и ракетницами.',
        [
          RESURCES.SCRAP,
          RESURCES.FIBER,
          RESURCES.WOOD,
