...
const ITEMS = {
  ...
  CONSTRUCTIONS: {
    ...
    RUB_PARUS: 'https://forded.github.io/ageofwater-map.github.io/items/rub_parus.png',
  },
};
...
const SHIPS = {
  T1: {
    ...
    MINNIE: {
      img: 'https://forded.github.io/ageofwater-map.github.io/ships/T1_minnie.webp',
      name: 'Минни (I)',
      url: 'https://ageofwater.fandom.com/wiki/Minnie_Minesweeper',
    },
    TRAGULA: {
      img: 'https://forded.github.io/ageofwater-map.github.io/ships/T1_tragula.webp',
      name: 'Трагула (I)',
  ...
  T3: {
    ...
    CHARISMA: {
      img: 'https://forded.github.io/ageofwater-map.github.io/ships/T3_charisma.webp',
      name: 'Харизма (III)',
      url: 'https://ageofwater.fandom.com/wiki/Charisma_Sailboat',
    },
    RIVIERA: {
      img: 'https://forded.github.io/ageofwater-map.github.io/ships/T3_riviera.webp',
      name: 'Ривьера (III)',
      url: 'https://ageofwater.fandom.com/wiki/Riviera_Motorboat',
    },
    REZKIJ: {
      img: 'https://forded.github.io/ageofwater-map.github.io/ships/T3_rezkij.webp',
      name: 'Резкий (III)',
      url: 'https://ageofwater.fandom.com/wiki/Abrupt_Patrol_Boat',
    },
  },
  T4: {
    ANCHOUS: {
    ...
    BRUNHILD: {
      img: 'https://forded.github.io/ageofwater-map.github.io/ships/T4_brunhild.webp',
      name: 'Брунгильда (IV)',
      url: 'https://ageofwater.fandom.com/wiki/Brynhild_Motor_Sailer',
    },
    BULDOG: {
      img: 'https://forded.github.io/ageofwater-map.github.io/ships/T4_buldog.webp',
      name: 'Бульдог (IV)',
      url: 'https://ageofwater.fandom.com/wiki/Gardariki_Monitor',
    },
    BURAN: {
      img: 'https://forded.github.io/ageofwater-map.github.io/ships/T4_buran.webp',
      name: 'Буран (IV)',
      url: 'https://ageofwater.fandom.com/wiki/Hulls',
    },
  },
  T5: {
    ...
    OCTA: {
      img: 'https://forded.github.io/ageofwater-map.github.io/ships/T5_octa.webp',
      name: 'Окта (V)',
      url: 'https://ageofwater.fandom.com/wiki/Octa_Patrol_Boat',
    },
  },
};
...
const worldPoints = {
  ...
  rangers: [
    ...
    [
      ...
      generateDescription(
        '8. Корабль T3',
        'https://forded.github.io/ageofwater-map.github.io/icons/ranger.png',
        `Корабль ${SHIPS.T3.CHARISMA.name}.`,
        [
          RESURCES.SCRAP,
          RESURCES.FIBER,
          RESURCES.WOOD,
  ...
  pirates: [
    [
      ...
      generateDescription(
        ...
        `Пиратский флот состояший из ${SHIPS.T4.ANCHOUS.name} вооруженных пулеметами/пушками, ${SHIPS.T3.CLEVER.name}, ${SHIPS.T4.BURAN.name} и ${SHIPS.T4.BRUNHILD.name}.`,
        [
          RESURCES.SCRAP,
          RESURCES.FIBER,
          RESURCES.WOOD,
        ...
        ],
        {
          ...
          [SHIPS.T4.BURAN.name]: [ITEMS.MODULES.GENERATOR.T4],
        },
        `На данном месте проблемы могут быть только от ${SHIPS.T3.CLEVER.name}, ${SHIPS.T4.BURAN.name} и ${SHIPS.T4.BRUNHILD.name}, в остальном фармится спокойно`,
        null,
        [SHIPS.T4.ANCHOUS, SHIPS.T3.CLEVER, SHIPS.T4.BURAN, SHIPS.T4.BRUNHILD],
      ),
    ],
    [
      -64.5,
    ...
    [
      ...
      generateDescription(
        '3. Флот T3-T4',
        'https://forded.github.io/ageofwater-map.github.io/icons/pirate.png',
        `Пиратский флот состояший из ${SHIPS.T4.MURENA.name}, ${SHIPS.T4.BRUNHILD.name} и ${SHIPS.T3.CLEVER.name}.`,
        [
          RESURCES.SCRAP,
          RESURCES.FIBER,
          RESURCES.WOOD,
        ...
        null,
        null,
        [SHIPS.T4.MURENA, SHIPS.T4.BRUNHILD, SHIPS.T3.CLEVER],
      ),
    ],
    [
      -156.8125,
    ...
    [
      ...
      generateDescription(
        '5. Флот T3-T4',
        'https://forded.github.io/ageofwater-map.github.io/icons/pirate.png',
        `Большой пиратский флот состояший из ${SHIPS.T4.MURENA.name}, ${SHIPS.T4.ANCHOUS.name}, ${SHIPS.T4.BULDOG.name}, ${SHIPS.T3.ZORKIJ.name} и ${SHIPS.T3.BISTRIY.name}.`,
        [
          RESURCES.SCRAP,
          RESURCES.FIBER,
          RESURCES.WOOD,
        ...
        null,
        null,
        [SHIPS.T4.MURENA, SHIPS.T4.ANCHOUS, SHIPS.T4.BULDOG, SHIPS.T3.ZORKIJ, SHIPS.T3.BISTRIY],
      ),
    ],
    [
      -218.4375,
    ...
    [
      ...
      generateDescription(
        '7. Флот T3-T4',
        'https://forded.github.io/ageofwater-map.github.io/icons/pirate.png',
        `Пиратский флот состояший из ${SHIPS.T4.MURENA.name}, ${SHIPS.T4.ANCHOUS.name}, ${SHIPS.T4.BULDOG.name}, ${SHIPS.T3.ZORKIJ.name} и ${SHIPS.T3.BISTRIY.name}.`,
        [
          RESURCES.SCRAP,
          RESURCES.FIBER,
          RESURCES.WOOD,
    ...
    [
      ...
      generateDescription(
        '12. Флот T1-T2',
        'https://forded.github.io/ageofwater-map.github.io/icons/pirate.png',
        `Флот из кораблей ${SHIPS.T1.NJORD.name} и ${SHIPS.T1.DINGHY.name}, быстро спавнится для прокачки без остановки`,
        [
          RESURCES.SCRAP,
          RESURCES.FIBER,
          RESURCES.WOOD,
        ...
        null,
        [SHIPS.T1.NJORD, SHIPS.T1.DINGHY],
      ),
    ],
    [
      -71.8125,
      ...
      generateDescription(
        ...
        [],
        `Для комфортного убийства стоит взять T4 корабль`,
        null,
        [SHIPS.T1.NJORD],
      ),
    ],
    ...
    [
      ...
      generateDescription(
        ...
        'https://forded.github.io/ageofwater-map.github.io/icons/pirate.png',
        `Большой флот из кораблей ${SHIPS.T1.DINGHY.name}, ${SHIPS.T1.NJORD.name} и дельтапланы пиратов.`,
        [
          RESURCES.SCRAP,
          RESURCES.FIBER,
          RESURCES.WOOD,
        ...
        null,
        [SHIPS.T1.DINGHY, SHIPS.T1.NJORD],
      ),
    ],
    [
      -151.0625,
    ...
    [
      ...
      generateDescription(
        '19. Флот T2-T5',
        'https://forded.github.io/ageofwater-map.github.io/icons/pirate.png',
        `Большой пиратский флот состояший из ${SHIPS.T5.REPEJ.name}, ${SHIPS.T4.ZABIJAKA.name}, ${SHIPS.T3.CLEVER.name} и ${SHIPS.T2.MARIANA.name}`,
        [
          RESURCES.SCRAP,
          RESURCES.FIBER,
          RESURCES.WOOD,
    ...
    [
      ...
      generateDescription(
        '23. Флот T3-T4',
        'https://forded.github.io/ageofwater-map.github.io/icons/pirate.png',
        `Пиратский флот состояший из ${SHIPS.T4.MURENA.name}, ${SHIPS.T4.BURAN.name}, ${SHIPS.T4.BRUNHILD.name} и ${SHIPS.T3.CLEVER.name}.`,
        [
          RESURCES.SCRAP,
          RESURCES.FIBER,
          RESURCES.WOOD,
        ...
        null,
        null,
        [SHIPS.T4.MURENA, SHIPS.T4.BURAN, SHIPS.T4.BRUNHILD, SHIPS.T3.CLEVER],
      ),
    ],
  ],
  scraps: [
  ...
  fczs: [
    [
      ...
      generateDescription(
        ...
        [RESURCES.AMMO, RESURCES.DYNAMITE],
        null,
    ...
    [
      ...
      generateDescription(
        ...
        'https://forded.github.io/ageofwater-map.github.io/icons/fczs.png',
        'Место для выполнения пешей задачи с получением ресурсов за прохождение',
        [RESURCES.PLATS, RESURCES.MECHANISM],
        null,
        'Прохождение подразумевается как ежедневная активность, награда накапливается в реальном времени.',
      ),
    ],
    [
      ...
      generateDescription(
        ...
        'https://forded.github.io/ageofwater-map.github.io/icons/fczs.png',
        'Место для выполнения пешей задачи с получением ресурсов за прохождение',
        [RESURCES.COPPER, RESURCES.COPPER_PLATES],
        null,
        'Прохождение подразумевается как ежедневная активность, награда накапливается в реальном времени.',
      ),
    ],
    [
      ...
      generateDescription(
        ...
        'https://forded.github.io/ageofwater-map.github.io/icons/fczs.png',
        'Место для выполнения пешей задачи с получением ресурсов за прохождение',
        [RESURCES.PLASTIC, RESURCES.PLASTIC_PLATE],
        null,
        'Прохождение подразумевается как ежедневная активность, награда накапливается в реальном времени.',
      ),
    ],
    ...
    [
      ...
      generateDescription(
        ...
        'https://forded.github.io/ageofwater-map.github.io/icons/fczs.png',
        'Место для выполнения пешей задачи с получением ресурсов за прохождение',
        [RESURCES.AMMO_DETAILS, RESURCES.REPAIR],
        null,
        'Прохождение подразумевается как ежедневная активность, награда накапливается в реальном времени.',
      ),
    ],
    ...
    [
      ...
      generateDescription(
        ...
        'https://forded.github.io/ageofwater-map.github.io/icons/fczs.png',
        'Место для выполнения пешей задачи с получением ресурсов за прохождение',
        [RESURCES.TEXTILE, RESURCES.FABRIC],
        null,
        'Прохождение подразумевается как ежедневная активность, награда накапливается в реальном времени.',
      ),
    ],
    [
      ...
      generateDescription(
        ...
        'https://forded.github.io/ageofwater-map.github.io/icons/fczs.png',
        'Место для выполнения пешей задачи с получением ресурсов за прохождение',
        [RESURCES.REACTIVE, RESURCES.CHEMICAL],
        null,
        'Прохождение подразумевается как ежедневная активность, награда накапливается в реальном времени.',
      ),
    ],
  ...
  armades: [
    [
      ...
      generateDescription(
        ...
        [
          ...
          RESURCES.STEEL,
          RESURCES.COPPER_PLATES,
          RESURCES.OST_MOSH_ORUJ,
          RESURCES.OST_AKUL_ORUJ,
          ITEMS.MODULES.MOTOR.T2,
          ITEMS.CONSTRUCTIONS.BAMBUK_SHIELD.T1,
          ITEMS.CONSTRUCTIONS.STEEL_SHIELD.T1,
          ITEMS.CONSTRUCTIONS.TUR_BAZA.T1,
        ...
        ],
        {
          ...
          [SHIPS.T4.MURENA.name]: [RESURCES.OST_MOSH_ORUJ],
          [SHIPS.T3.BISTRIY.name]: [RESURCES.OST_MOSH_ORUJ],
          [SHIPS.T3.ZORKIJ.name]: [RESURCES.OST_MOSH_ORUJ, ITEMS.MODULES.GENERATOR.T3],
        },
    ...
    [
      ...
      generateDescription(
        ...
        'https://forded.github.io/ageofwater-map.github.io/icons/armade.png',
        `Усиленный флот армады в нескольких волнах:</br><b>1 Волна:</b> ${SHIPS.T3.ZORKIJ.name} и ${SHIPS.T3.SHEVRON.name}.</br><b>2 Волна:</b> ${SHIPS.T4.MURENA.name} и ${SHIPS.T4.ANCHOUS.name}.</br><b>3 Волна:</b> ${SHIPS.T4.ANCHOUS.name} и ${SHIPS.T5.OCTA.name}.`,
        [
          RESURCES.SCRAP,
          RESURCES.FIBER,
          RESURCES.WOOD,
        ...
        ],
        {
          ...
          [SHIPS.T4.MURENA.name]: [RESURCES.OST_MOSH_ORUJ, RESURCES.OST_AKUL_ORUJ],
          [SHIPS.T3.SHEVRON.name]: [RESURCES.OST_MOSH_ORUJ],
          [SHIPS.T3.ZORKIJ.name]: [RESURCES.OST_MOSH_ORUJ, ITEMS.MODULES.GENERATOR.T3],
        },
        `В этой точке можно абордажить ${SHIPS.T3.ZORKIJ.name}, ${SHIPS.T3.SHEVRON.name}, ${SHIPS.T4.MURENA.name}, ${SHIPS.T4.ANCHOUS.name}.`,
        null,
        [SHIPS.T5.OCTA, SHIPS.T4.ANCHOUS, SHIPS.T4.MURENA, SHIPS.T3.ZORKIJ, SHIPS.T3.SHEVRON],
      ),
    ],
    [
      10.3125,
      ...
      generateDescription(
        ...
        'https://forded.github.io/ageofwater-map.github.io/icons/armade.png',
        `Усиленный флот армады в нескольких волнах:</br><b>1 Волна:</b> ${SHIPS.T3.ZORKIJ.name} и ${SHIPS.T3.BISTRIY.name}.</br><b>2 Волна:</b> ${SHIPS.T4.BASTION.name} и ${SHIPS.T4.MURENA.name}.</br><b>3 Волна:</b> ${SHIPS.T4.ANCHOUS.name} и ${SHIPS.T5.OCTA.name}.`,
        [
          RESURCES.SCRAP,
          RESURCES.FIBER,
          RESURCES.WOOD,
        ...
        {
          [SHIPS.T4.BASTION.name]: [RESURCES.OST_MOSH_ORUJ, RESURCES.OST_AKUL_ORUJ],
          [SHIPS.T4.ANCHOUS.name]: [
            RESURCES.OST_MOSH_ORUJ,
            ITEMS.CONSTRUCTIONS.STEEL_SHIELD.T1,
            ITEMS.CONSTRUCTIONS.STEEL_SHIELD.T2,
    ...
    [
      ...
      generateDescription(
        ...
        'https://forded.github.io/ageofwater-map.github.io/icons/armade.png',
        `Усиленный флот армады в нескольких волнах:</br><b>1 Волна:</b> ${SHIPS.T3.ZORKIJ.name} и ${SHIPS.T3.BISTRIY.name}.</br><b>2 Волна:</b> ${SHIPS.T4.SHPROT.name} и ${SHIPS.T4.MURENA.name}.</br><b>3 Волна:</b> ${SHIPS.T4.ANCHOUS.name} и ${SHIPS.T5.OCTA.name}.`,
        [
          RESURCES.SCRAP,
          RESURCES.FIBER,
          RESURCES.WOOD,
    ...
    [
      ...
      generateDescription(
        ...
        ],
        {
          ...
          [SHIPS.T4.MURENA.name]: [RESURCES.OST_MOSH_ORUJ, RESURCES.OST_AKUL_ORUJ],
          [SHIPS.T3.ZORKIJ.name]: [RESURCES.OST_MOSH_ORUJ, ITEMS.MODULES.GENERATOR.T3],
          [SHIPS.T3.HORIZONT.name]: [RESURCES.OST_MOSH_ORUJ, RESURCES.OST_AKUL_ORUJ],
        },
    ...
    [
      ...
      generateDescription(
        ...
        [
          ...
          RESURCES.PLASTIC,
          RESURCES.MECHANISM,
          ITEMS.WEAPONS.GRANATOMET.JARED,
        ],
        null,
  ...
  bqs: [
    ...
    [
      ...
      130.75,
      generateDescription(
        'Популярное место появления большого грузового корабля-босса "Дредриппер"',
        'https://forded.github.io/ageofwater-map.github.io/icons/rep_quests.png',
        'Сильный одиночный большой который появляется в любом месте скопления игроков за картой в пределах <b>2000 единиц дистанции от игроков</b>, корабль который убивается путем пробивания 4-х щитов по бортам и поломки двигателей за ними. Вооружен пулеметами и ракетницами.',
        [
          RESURCES.SCRAP,
          RESURCES.FIBER,
          RESURCES.WOOD,
...
function generateDescription(title, image = null, description = null, resources = [], boardings = [], nuances = null, actions = [], ships = [], isHidable = false) {
  ...
  if (image) {
    context += `<div class="popup-main-image"><img src="${image}" alt="${title}" title="${title}" width="100" height="100"></div>`;
  }
  context += '<div class="clr"></div>';
  if (actions) {
    context += '<div class="popup-actions-block">';
    for (const action of actions) {
      context += `<img class="popup-resource-image" src="${action.img}" alt="${action.alt}" title="${action.alt}" width="25" height="25" />`;
    }
    context += '</div>';
  }
...
function generateScrapPopup() {
  return generateDescription(
    ...
    [RESURCES.SCRAP, RESURCES.COPPER, RESURCES.STEEL, RESURCES.COPPER_PLATES, RESURCES.FIBER],
    null,
...
function generateAmmoPopup() {
  return generateDescription(
    ...
    RESURCES.AMMO,
    'Место добычи при помощи драги',
    [RESURCES.AMMO, RESURCES.SCRAP, RESURCES.WOOD, RESURCES.TEXTILE, RESURCES.AMMO_DETAILS],
    null,
...
function generateChemicalPopup() {
  return generateDescription(
    ...
    RESURCES.CHEMICAL,
    'Место добычи при помощи драги',
    [RESURCES.CHEMICAL, RESURCES.WOOD, RESURCES.FIBER, RESURCES.SCRAP],
    null,
...
function generateDynamitePopup() {
  return generateDescription(
    ...
    RESURCES.DYNAMITE,
    'Место добычи при помощи драги',
    [RESURCES.DYNAMITE, RESURCES.AMMO, RESURCES.CHEMICAL, RESURCES.SCRAP, RESURCES.FIBER],
    null,
...
function generateRockPopup() {
  return generateDescription(
    ...
    [RESURCES.BALLAST, RESURCES.BAIT, RESURCES.WOOD, RESURCES.FIBER, RESURCES.EAT],
    null,
    'В малом количестве могут добываться и иные ресурсы которые используются в исследованиях и строительстве. Рядом с этой горой находится таинственный сундук с ресурсами который можно достать драгой, респавн данного сундука примерно 30 минут. Из сундука можно получить 0-25к медалей, детали акульего оружия, и иные ресунсы для крафта в небольшом количестве.',
    null,
    null,
    true,
  );
